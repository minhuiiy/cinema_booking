...
class AuthInterceptor extends Interceptor {
  ...
  @override
  Future onRequest(RequestOptions options, RequestInterceptorHandler handler) async {
    LogHelper.logDebug(tag: "AuthInterceptor", message: "Adding Authorization token...");
  ...
  void onError(DioException err, ErrorInterceptorHandler handler) async {
    ...
    if (err.response?.statusCode == 401) {
      ...
      LogHelper.logDebug(tag: "AuthInterceptor", message: "Token expired, refreshing token...");
      ...
      try {
        ...
        LogHelper.logError(tag: "AuthInterceptor", message: "Refresh token failed: $e");
      }
    }
